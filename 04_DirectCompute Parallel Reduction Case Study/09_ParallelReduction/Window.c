...
#define THREADSX 128			// number of threads in the thread group used in the compute shader
#define THREADSY 128			// number of threads in the thread group used in the compute shader
