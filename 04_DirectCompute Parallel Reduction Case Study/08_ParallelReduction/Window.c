...
#define THREADSX 64			// number of threads in the thread group used in the compute shader
#define THREADSY 64			// number of threads in the thread group used in the compute shader
